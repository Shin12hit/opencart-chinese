...
$_['text_log']                       = '错误日志';
$_['text_event']                     = '事件';
$_['text_extension']                 = '扩展插件';
$_['text_filter']                    = '筛选';
$_['text_geo_zone']                  = '地理区域';
$_['text_gdpr']                 = '《通用数据保护条例》（GDPR）';
$_['text_information']               = '信息管理';
$_['text_installer']                 = '安装扩展插件';
$_['text_language']                  = '语言';
$_['text_language_editor']      	 = '语言编辑器';
$_['text_layout']                    = '布局排版';
$_['text_localisation']              = '本地化设置';
$_['text_location']                  = '线下商店位置';
$_['text_contact']                   = '邮件';
$_['text_marketing']                 = '市场推广';
$_['text_marketplace']          	 = '扩展插件商城';
...
$_['text_sale']                      = '销售';
$_['text_setting']                   = '设置';
$_['text_seo']                  = '搜索引擎最佳化（SEO）';
$_['text_seo_profile']          = '搜索引擎最佳化（SEO）方案';
$_['text_seo_regex']            = 'SEO Regex';
$_['text_seo_url']              	 = '搜索引擎网址（SEO URL）';
...
$_['text_zone']                      = '区域设置';
$_['text_recurring']                 = '分期付款方案';
$_['text_order_recurring']           = '分期付款订单';
$_['text_paypal']                    = '贝宝支付（PayPal）';
