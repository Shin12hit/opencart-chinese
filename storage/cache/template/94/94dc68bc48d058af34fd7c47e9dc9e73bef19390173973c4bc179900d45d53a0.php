...
class __TwigTemplate_e74d9e4e0de72e350e12cb4720f550be7e980f5d131a5052e49a4c0ca22fa64f extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
      ...
      <div class=\"card-body\">
            ...
            <table class=\"table table-bordered table-hover\">
              <thead>
                <tr>
                  ...
                  <td class=\"text-left\">";
        // line 36
        if ((0 === twig_compare(($context["sort"] ?? null), "c.name"))) {
            // line 37
            echo "                      <a href=\"";
        ...
        echo "</td>
                  <td class=\"text-left\">";
        // line 41
        if ((0 === twig_compare(($context["sort"] ?? null), "z.name"))) {
            // line 42
            echo "                      <a href=\"";
        ...
        echo "</td>
                  <td class=\"text-left\">";
        // line 46
        if ((0 === twig_compare(($context["sort"] ?? null), "z.code"))) {
            // line 47
            echo "                      <a href=\"";
        ...
        if (($context["zones"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["zone"]) {
                ...
                // line 58
                if (twig_in_filter(twig_get_attribute($this->env, $this->source, $context["zone"], "zone_id", [], "any", false, false, false, 58), ($context["selected"] ?? null))) {
                    // line 59
                ...
                echo "</td>
                      <td class=\"text-left\">";
                // line 63
                echo twig_get_attribute($this->env, $this->source, $context["zone"], "country", [], "any", false, false, false, 63);
                echo "</td>
                      <td class=\"text-left\">";
                // line 64
                echo twig_get_attribute($this->env, $this->source, $context["zone"], "name", [], "any", false, false, false, 64);
                echo "</td>
                      <td class=\"text-left\">";
                // line 65
                echo twig_get_attribute($this->env, $this->source, $context["zone"], "code", [], "any", false, false, false, 65);
                echo "</td>
                      <td class=\"text-right\"><a href=\"";
                // line 66
                echo twig_get_attribute($this->env, $this->source, $context["zone"], "edit", [], "any", false, false, false, 66);
                echo "\" data-toggle=\"tooltip\" title=\"";
