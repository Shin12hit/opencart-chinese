...
class __TwigTemplate_c03fdbd61d7551057999f19de0a4c25490c71abaceb5ca441737cf70044e066c extends Template
{
    private $source;
    private $macros = [];
        ...
        if (($context["extensions"] ?? null)) {
              ...
              <td class=\"text-right\">";
                ...
                if (twig_get_attribute($this->env, $this->source, $context["extension"], "installed", [], "any", false, false, false, 31)) {
                    ...
                    if (twig_get_attribute($this->env, $this->source, $context["extension"], "module", [], "any", false, false, false, 32)) {
                        ...
                        echo "\" class=\"btn btn-primary\"><i class=\"fas fa-plus-circle\"></i></a> ";
                    } else {
                        echo " <a href=\"";
                        echo twig_get_attribute($this->env, $this->source, $context["extension"], "edit", [], "any", false, false, false, 32);
                        echo "\" data-toggle=\"tooltip\" title=\"";
            ...
            ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["module"]) {
                    // line 39
                    echo "              <tr>
                <td class=\"text-left\">&nbsp;&nbsp;&nbsp;<i class=\"fas fa-folder-open\"></i>&nbsp;&nbsp;&nbsp;";
                    // line 40
                ...
                <td class=\"text-right\"><a href=\"";
                    ...
                    echo "\" data-toggle=\"tooltip\" title=\"";
                    echo ($context["button_edit"] ?? null);
                    echo "\" class=\"btn btn-info\"><i class=\"fas fa-pencil-alt\"></i></a> <a href=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["module"], "delete", [], "any", false, false, false, 42);
                    echo "\" data-toggle=\"tooltip\" title=\"";
                    echo ($context["button_delete"] ?? null);
                    echo "\" class=\"btn btn-warning\"><i class=\"fas fa-trash-alt\"></i></a></td>
              </tr>
            ";
                }
