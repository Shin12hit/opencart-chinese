...
class __TwigTemplate_67f7dad1190846f64db23d1dc3da0f45f51b74fb746ceb6f6cd789f725438790 extends Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"page-header\">
    <div class=\"container-fluid\">
      <div class=\"float-right\"><a href=\"";
        ...
        echo "') ? \$('#form-download').submit() : false;\"><i class=\"fas fa-trash-alt\"></i></button>
      </div>
      <h1>";
        // line 8
    ...
    ";
      ...
      <div class=\"card-body\">
            ...
            <table class=\"table table-bordered table-hover\">
              <thead>
                <tr>
                  ...
                  <td class=\"text-left\">";
        // line 36
        if ((0 === twig_compare(($context["sort"] ?? null), "dd.name"))) {
            // line 37
            echo "                      <a href=\"";
        ...
        echo "</td>
                  <td class=\"text-right\">";
        // line 41
        if ((0 === twig_compare(($context["sort"] ?? null), "d.date_added"))) {
            // line 42
            echo "                      <a href=\"";
        ...
        if (($context["downloads"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["download"]) {
                ...
                // line 53
                if (twig_in_filter(twig_get_attribute($this->env, $this->source, $context["download"], "download_id", [], "any", false, false, false, 53), ($context["selected"] ?? null))) {
                    // line 54
                    echo "                          <input type=\"checkbox\" name=\"selected[]\" value=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["download"], "download_id", [], "any", false, false, false, 54);
                ...
                echo "</td>
                      <td class=\"text-left\">";
                // line 58
                echo twig_get_attribute($this->env, $this->source, $context["download"], "name", [], "any", false, false, false, 58);
                echo "</td>
                      <td class=\"text-right\">";
                // line 59
                echo twig_get_attribute($this->env, $this->source, $context["download"], "date_added", [], "any", false, false, false, 59);
                echo "</td>
                      <td class=\"text-right\"><a href=\"";
                // line 60
                echo twig_get_attribute($this->env, $this->source, $context["download"], "edit", [], "any", false, false, false, 60);
                echo "\" data-toggle=\"tooltip\" title=\"";
